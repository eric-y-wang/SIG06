...
# prefilter dds
# remove any gene with fewer than 2 counts in the smallest group size
smallestGroupSize <- 3
...
There don't appear to be any major outliers by plate, sequencing depth, or biological group.
...
resLFCIl4virus <- results(dds, contrast = c("treatment","IL4_20x","p123_20x"), independentFiltering=F, filterFun=ihw)
